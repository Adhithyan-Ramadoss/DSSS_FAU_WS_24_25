...
def plot_data(file_pairs: List[Tuple[str, str, str]]) -> None:
    ...
    for i, file_pair in enumerate(file_pairs):
        ...
        # The segmentation is white in active regions and black everywhere else, we can exploit this fact to easily
        # derive a red segment mask to be overlaid on the base image.
        # Then do a element wise max operation between the base image and the modified segment mask on the red channel
